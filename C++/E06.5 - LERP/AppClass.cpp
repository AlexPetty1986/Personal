...
void Application::InitVariables(void)
{
	...
	//init the mesh
	m_pMesh = new MyMesh();
	m_pMesh->GenerateSphere(0.5f, 6, C_RED);
}
...
void Application::Display(void)
{
	...
	*/
	...
	if (!bInit)
	{
		...
		v3Stop.push_back(vector3(-1, 2, -3));
		v3Stop.push_back(vector3(-3, -2, -1));
		v3Stop.push_back(vector3(-2, -3, 1));
		v3Stop.push_back(vector3(-2, 1, -3));
		v3Stop.push_back(vector3(-1, -3, 2));
		v3Stop.push_back(vector3(-4, -2, 0));
		v3Stop.push_back(vector3(0, 2.5, 0));
		v3Stop.push_back(vector3(0, -2.5, 0));
		v3Stop.push_back(vector3(1, -2.5, -1));
		v3Stop.push_back(vector3(-1.0f, 1.0f, -3.0f));
		v3Stop.push_back(vector3(1.0f, 3.0f, -5.0f));
		v3Stop.push_back(vector3(2.0f, 2.0f, -5.0f));
