...
function changeSection(type)
{
    ...
    if(type == 'web')
    {
        projSection.innerHTML = `<div id="project1" class="carousel slide">
        <h1 style="text-align: center;">Web-Based Programs</h1>
    ...
    {
        projSection.innerHTML = `<div id="project2" class="carousel slide">
        <h1 style="text-align: center;">C++ Programs</h1>
        <div class="carousel-indicators">
    ...
    {
        projSection.innerHTML = `<div id="project3" class="carousel slide">
        <h1 style="text-align: center;">C# Programs</h1>
        <div class="carousel-indicators">
    ...
    else if(type == 'python')
    {
        ...
        <h1 style="text-align: center;">Python Programs</h1>
        <div class="carousel-indicators">
    ...
    {
        projSection.innerHTML = `<div id="project5" class="carousel slide">
