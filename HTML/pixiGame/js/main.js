...
// game variables
let startScene;
let gameScene,ship, scoreLabel, lifeLabel, gameOverScoreLabel, shootSound, hitSound,fireballSound, levelComplete, gameOverSound, music;
let gameOverScene;
...
function setup() 
{
    ...
    music = new Howl(
    {
        src: ['sounds/IntergalacticOdyssey.mp3']
    });
...
function fireBullet(e)
{
    ...
    if(score >= 5)
    {
        ...
        bullets.push(b, b2, b3);
        gameScene.addChild(b, b2, b3);
    }
    shootSound.play();
}
...
function end()
{
    ...
    bullets.forEach(c => gameScene.removeChild(b));
    bullets = [];
