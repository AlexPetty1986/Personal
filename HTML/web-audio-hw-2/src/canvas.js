...
function setupCanvas(canvasElement,analyserNodeRef){
	...
	gradient = utils.getLinearGradient(ctx,0,0,0,canvasHeight,[{percent:.2,color:"blue"},{percent:.4,color:"green"},{percent:.6,color:"yellow"},{percent:.8,color:"red"},{percent:1,color:"magenta"}]);
